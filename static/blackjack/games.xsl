    ...
    <xsl:template match="casino">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0, 0, 1800, 900">
            ...
            <foreignObject x="30%" y="30%" width="100%" height="100%" >
                <form xmlns="http://www.w3.org/1999/xhtml" action="/bj/newGame/{$playerID}/{$balance}" method="POST" id="formMenu" style="display: inline;" >
             ...
             <xsl:variable name="counter" select="position()"/>
                ...
                <form xmlns="http://www.w3.org/1999/xhtml" action="/bj/join/{blackjack/@id}/{$playerID}/{$balance}" method="POST" id="formjoin" style="display: inline;" >
            ...
            <foreignObject x="80%" y="30%"  width="100%" height="100%">
                <form xmlns="http://www.w3.org/1999/xhtml" action="/bj/join/{blackjack[position()= 2]/@id}/{$playerID}/{$balance}" method="POST" id="formjoin2" style="display: inline;" >
